...
private:
	...
	void createRenderPass() {		///my
		...
		VkAttachmentDescription colorAttachmentResolve{}; /// my
...
public:
	...
	static void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods)
	{
		...
		case GLFW_PRESS:
			...
			{
			case GLFW_KEY_F:
				app->camera.type = Camera::firstperson;
				break;
			case GLFW_KEY_L:
				app->camera.type = Camera::lookat;
				break;
			}*/
