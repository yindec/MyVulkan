//#include <vulkan/vulkan.h>	//replaced by `#define GLFW_INCLUDE_VULKAN`
...
private:
	...
	void createSwapChain() {
		...
		/*std::cout << "indices.graphicsFamily.value() = " << indices.graphicsFamily.value() << "\n" <<
	...
	void createRenderPass() {
		...
		colorAttachment.loadOp = VK_ATTACHMENT_LOAD_OP_CLEAR;		///CHANGE >LOAD
	...
	void createDepthResources() {
		...
		createImage(swapChainExtent.width, swapChainExtent.height,1, depthFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, depth.image, depth.memory);
	...
	// pickPhysicalDevice swapChainDetails
	...
	VkSurfaceFormatKHR chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availbleFormats) {
		for (const auto& availableFormat : availbleFormats) {
